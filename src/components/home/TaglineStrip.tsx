...
const TaglineStrip: React.FC = () => {
  ...
  return (
    <div className="w-full bg-gray-200 dark:bg-[#0D1017] text-gray-800 dark:text-gray-200 py-4 px-6 border-y border-black/10 dark:border-white/10 overflow-hidden">
