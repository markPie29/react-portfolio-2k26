...
const TaglineStrip: React.FC<TaglineStripProps> = ({
  ...
  return (
    <div className="w-full bg-gradient-to-r from-[#0077b6] via-[#00b4d8] to-[#48cae4] text-white py-3 border-y border-white/20 overflow-hidden whitespace-nowrap select-none shadow-md">
      <motion.div
